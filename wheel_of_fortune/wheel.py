...
class WOFHumanPlayer(WOFPlayer):
    def getMove(self, category, obscured_phrase, guess):
        ...
        self.guess = guess
        guess = input(f"{self.name} - {self.prizeMoney}\n\nCategory: {self.category}\n\nPhrase:  {self.obscured_phrase}\n\nGuessed: {self.guess}\n\nGuess a letter, phrase, or type 'exit' or 'pass': ")
        return guess
...
def spinWheel():
    with open("Py3-Specialization\wheel_of_fortune\wheel.json", 'r') as f:
...
def getRandomCategoryAndPhrase():
    with open("Py3-Specialization\wheel_of_fortune\phrases.json", 'r') as f:
